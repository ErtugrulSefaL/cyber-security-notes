# Offensive_Security — Reconnaissance
...
<dt><b>Tags</b></dt><dd>#MOC #Reconnaissance</dd>
<dt><b>Status</b></dt><dd>status/active</dd>
</dl>

</details>

> Reconnaissance techniques: passive & active info gathering, subdomain/host discovery, port scanning, and OSINT (Shodan, Nmap, NSE).
...
- [Passive Reconnaissance](/Offensive_Security/Reconnaissance/Passive_Reconnaissance.md)
- [Shodan](/Offensive_Security/Reconnaissance/Shodan.md)

### Active Reconnaissance & Scanning
- [Active Reconnaissance](/Offensive_Security/Reconnaissance/Active_Reconnaissance.md)
- [Nmap Live Host Discovery](/Offensive_Security/Reconnaissance/Nmap_Live_Host_Discovery_01.md)
...
- [Networking Fundamentals](/General/Networking/0_Networking_MOC.md)
